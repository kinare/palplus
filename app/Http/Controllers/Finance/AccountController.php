...
class AccountController extends BaseController
{
     ...
     *   @SWG\Parameter(name="currency",in="query",description="currency",required=false,type="string"),
     *   @SWG\Parameter(name="cardno",in="query",description="card number",required=false,type="string"),
     *   @SWG\Parameter(name="beneficiary",in="query",description="beneficiary name",required=false,type="string"),
