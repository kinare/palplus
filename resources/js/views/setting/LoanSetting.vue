<template>
  <div>
    <hero-bar :has-right-visible="true">Loan Settings</hero-bar>
    <section class="section is-main-section">
      <card-component v-if="settings" title="Settings" class="has-mobile-sort-spaced">
        ...
        <b-field horizontal label="Qualification Period(days)">
          <b-input
            :value="settings.qualification_period"
        ...
        <b-field horizontal label="Loan Limit(of Total Contribution)">
          <b-input
            :value="settings.fixed_amount ? settings.limit_amount : settings.limit_rate + '%'"
            custom-class="is-static"
            expanded
            readonly
          />
        ...
        <b-field horizontal label="Interest Rate/Amount">
          <b-input
            :value="settings.fixed_interest_amount ? settings.interest_amount : settings.interest_rate + '%'"
            custom-class="is-static"
            expanded
            readonly
          />
        ...
        <b-field horizontal label="Display Loan Info">
          <b-input
            :value="settings.show_loans ? 'Yes' : 'No'"
            custom-class="is-static"
            expanded
            readonly
          />
...
export default {
  ...
  computed: {
    settings() {
      return this.$store.getters["Loan/setting"]
        .filter(s => {
