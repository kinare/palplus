<template>
  <div>
    ...
    <section class="section is-main-section">
      <card-component title="Compose Message" class="has-mobile-sort-spaced">
        <form>
          <div class="columns">
            <div class="column is-half">
              <b-field grouped class="margin-top: 20px;">
                <b-field>
                  <b-select v-model="form.code">
                ...
                <b-field expanded>
                  <b-input placeholder="Phone Number" v-model="form.phone"></b-input>
                </b-field>
                <b-button @click.prevent="addPhoneNumberToList" type="is-primary">Add</b-button>
              </b-field>
            </div>
            <div class="column is-half">
              <b-field>
                <b-input v-model="form.message" placeholder="Your message ..." type="textarea"></b-input>
              </b-field>
            </div>
          </div>
          <hr />
          <section v-if="form.phoneList.length > 0">
            ...
            <b-button class="button" @click="sendMessage" type="is-info">Send</b-button>
          </section>
        </form>
      </card-component>
    </section>
