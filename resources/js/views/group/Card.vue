<template>
    <div>
        <hero-bar :has-right-visible="true">
            Group Card
            <a slot="right"  class="button" @click="toggleActive(group.id)">
                {{group.active ? 'Deactivate' : 'Activate'}}
            </a>
            <a slot="right"  class="button"  @click="suspend(group.id)">
                Suspend
            </a>
        </hero-bar>
           ...
           <div class="columns">
               <div class="column is-half">
                   ...
                   <b-field horizontal label="Status">
                       <b-input :value="group.active ? 'Active' : 'Inactive'" custom-class="is-static" readonly/>
                   </b-field>
