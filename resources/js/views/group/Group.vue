                        ...
                        <b-table-column label="Actions">
                            <b-dropdown aria-role="list">
                                ...
                                <b-dropdown-item has-link aria-role="listitem">
                                    <router-link
                                        :to="`group-card/${props.row.id}`"
                                        >details</router-link
                                    >
                                    <router-link
                                        :to="`transactions/credit/Group/${props.row.id}`"
                                        >deposits</router-link
                                    >
                                    <router-link
                                        :to="`transactions/debit/Group/${props.row.id}`"
                                        >withdrawals</router-link
                                    >
                                    <router-link
                                        :to="`group-withdrawal-requests/${props.row.id}`"
                                        >withdrawal requests</router-link
                                    >
                                    <router-link
                                        :to="`pending-payments/${props.row.id}/group`"
                                        >Pending payment</router-link
                                    >
                                    <!-- <router-link
                                        disabled
                                        :to="`group-chats/${props.row.id}`"
                                        >chats</router-link
                                    > -->
                                    ...
                                    >
                                    <router-link
                                        :to="`members/${props.row.id}/admins`"
                                        >admins</router-link
                                    >
                                    <router-link
                                        :to="`members/${props.row.id}/loan-approvers`"
                                        >loan approvers</router-link
                                    >
                                    <router-link
                                    ...
                                    >
                                    <router-link
                                        :to="`membership-settings/${props.row.id}`"
                                        >membership settings</router-link
                                    >
                                    <router-link
                                        :to="`loans/all/group/${props.row.id}`"
                                        >loans</router-link
                                    >
                                    <router-link
                                        :to="`loan-settings/${props.row.id}`"
                                        >loan settings</router-link
                                    >
                                    <!--                                    <router-link :to="`withdrawal-settings/${props.row.id}`">withdrawal settings</router-link>-->
                                    <router-link
                                        :to="`activity/event/${props.row.id}`"
                                        >Events</router-link
                                    >
                                    <router-link
                                        :to="`activity/meeting/${props.row.id}`"
                                        >Meetings</router-link
                                    >
                                    <router-link
                                        :to="`activity/tour/${props.row.id}`"
                                        >Tours</router-link
                                    >
